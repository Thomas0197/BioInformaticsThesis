...
#Reading in the list of genes
List = read.delim("EnrichmentList.txt", header = FALSE, sep = "\t", dec = ".")
List
first_vector = as.character(List[, 1]);
summary(first_vector)

#Converting the genes to ENTREZID IDs for the package to use
eg = bitr(first_vector, fromType="SYMBOL", toType="ENTREZID", OrgDb="org.Mm.eg.db")
...
#converting the gene list to ENSEMBL
